...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`💰 Paystack Test: http://localhost:${PORT}/api/wallet/test-paystack`);
  console.log(`👤 Profile API: http://localhost:${PORT}/api/profile/`);
  console.log(`📊 Environment: ${process.env.NODE_ENV}`);
  console.log(`✨ Pretty URLs enabled - .html extensions removed`);
  console.log(`📝 Test URLs with query parameters:`);
  console.log(`   - http://localhost:${PORT}/history?tab=transactions`);
  console.log(`   - http://localhost:${PORT}/history?tab=wallet`);
  console.log(`   - http://localhost:${PORT}/history?tab=orders`);
});
